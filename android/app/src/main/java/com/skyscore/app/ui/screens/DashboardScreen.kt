...
package com.skyscore.app.ui.screens
...
import com.skyscore.app.ui.components.Chip
import com.skyscore.app.ui.components.DateTimeSelector
import com.skyscore.app.ui.components.LabeledValue
import com.skyscore.app.ui.components.ObjectSheet
import com.skyscore.app.ui.components.ScoreBadge
import com.skyscore.app.ui.components.SectionCard
...
private fun TargetRow(
    scored: com.skyscore.app.scoring.ScoringEngine.Scored,
    onClick: () -> Unit,
) {
    Row(
        Modifier
...
internal fun produceStars(
    ...
    List<com.skyscore.app.catalog.Star>,
    Map<String, com.skyscore.app.catalog.Star>,
    List<com.skyscore.app.catalog.Constellation>,
    >> {
    val empty = Triple(
        emptyList<com.skyscore.app.catalog.Star>(),
        emptyMap<String, com.skyscore.app.catalog.Star>(),
        emptyList<com.skyscore.app.catalog.Constellation>(),
    )
